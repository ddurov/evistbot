...
class LongPoll extends vk_api
{
     ...
     * @return |null
     */
    public function initVars(&$peer_id = null, &$message_original = null, &$message = null, &$payload = null, &$from_id = null, &$type = null, &$data = null, &$invite = null, &$check = null, &$from_id_fwd = null) {
        $data = $this->data;
        ...
        $peer_id = isset($data->object->peer_id) ? $data->object->peer_id : null;
        $message_original = isset($data->object->text) ? $data->object->text : null;
        $message = mb_strtolower($message_original);
        $payload = isset($data->object->payload) ? json_decode($data->object->payload, true) : null;
        $from_id = isset($data->object->from_id) ? $data->object->from_id : null;
        $invite  = isset($data->object->message->action->type) ? $data->object->message->action->type : null;
        $check   = isset($data->object->message->action->menber_id) ? $data->object->message->action->menber_id : null;
        $from_id_fwd  = isset($data->object->message->reply_message->from_id) ? $data->object->message->reply_message->from_id : null;
        $data = $data_backup;
        return $data_backup;
    }
